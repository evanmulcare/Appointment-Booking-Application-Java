...
public class HistoryBookingController {
    ...
    public HistoryBookingController(View view, Context context) {
        this.view = view;
        initialize();
    }
    ...
    private void initialize() {
        ...
        List<Booking> historyBookings = getHistoryBookings();
        showBookingsView(verticalRecyclerView,noBookingHeading,noBookingSubtext,historyBookings);
    }

    private List<Booking> getHistoryBookings() {
        ...
        for (Booking booking : bookingList) {
            if (isBookingHistory(booking, formattedDate, formattedTime)) {
    ...
    private boolean isBookingHistory(Booking booking, String formattedDate, String formattedTime) {
